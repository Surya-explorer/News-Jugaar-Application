     ...
     <div>  
        <Router>
          <Navbar/>
            ...
            />
          <Routes>
            {/* If you want to render a component using route , you cannot be able to render that component outside route , you need to do it within route using "element"  */}
          <Route exact path= "/" element = {<News setProgress = {this.setProgress} key = "home" pageSize = {5} country = "in" category = "general" />}></Route>
